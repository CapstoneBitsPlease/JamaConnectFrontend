    ...
    return (
        <table className="sync_settings_page_table">
            <tbody>
                ...
                <tr>
                    <th className="sync_settings_page_table_label">Fields ready to sync:</th>
                    <td className="sync_settings_page_table_data">{props.numFieldsToSync}</td>
                </tr>
                <tr>
                    <th className="sync_settings_page_table_label">Current sync interval:</th>
                    <td className="sync_settings_page_table_data">{props.syncInterval} {props.selectedTimeUnit}</td>
                </tr>
                <tr>
